        ...
        <Grid item xs={6}>
          <Paper elevation={3} style={{ 'height': '200px' }}>
            ...
            <Row>
              ...
              <Col md={6}>
                <div style={{ 'color': '#4194D8', 'fontSize': '25px', 'lineHeight': '30px', 'display': 'flex', 'flexDirection': 'row', 'justifyContent': 'center', 'fontWeight': 'bold' }}>{props.faturamentoDiario}</div>
            ...
            <Row style={{ 'paddingBottom': '20px', 'paddingTop': '30px' }}>
              ...
              <Col md={6}>
                <div style={{ 'color': '#4194D8', 'fontSize': '25px', 'lineHeight': '30px', 'display': 'flex', 'flexDirection': 'row', 'justifyContent': 'center', 'fontWeight': 'bold' }}>{props.ticketMedioDiario}</div>
